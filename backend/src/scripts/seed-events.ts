 ...
 *
 * This seed used to insert two English-only sample Mega Case events. All game
...
logger.warn("seed:events is deprecated — run `yarn content:launch` instead (trilingual daily/mini/mega/season content).");
process.exit(1);
